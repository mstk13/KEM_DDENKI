...
| **開発（外部）** | https://harmony-graffiti-jalapeno.ngrok-free.dev | 開発者のみ | 外部ネットワークからのアクセス用（ngrok） |
...
**開発環境URL: http://192.168.0.35:8081/**
...
| アプリ | URL | 概要 |
|--------|-----|------|
| ポータル | http://192.168.0.35:8081/ | 全アプリへのランチャー（開発用） |
| 開発管理 | http://192.168.0.35:8081/dev/ | 開発タスク・進捗管理・マスター設定 |
| 入札案件管理 | http://192.168.0.35:8081/bid/ | 案件収集・進捗管理・費用分析 |
| 材料管理 | http://192.168.0.35:8081/material/ | 見積もり vs 発注の消化率追跡 |
| 作業日報 | http://192.168.0.35:8081/nippou/ | 日報入力・作業員管理・月次集計 |
| 人事評価（入力） | http://192.168.0.35:8081/eval/ | アンケート方式の評価入力 |
| 人事評価（管理） | http://192.168.0.35:8081/eval-admin/ | 結果閲覧・自己vs他己比較・PDF出力 |
| 人材管理 | http://192.168.0.35:8081/jinzai/ | 社員情報の登録・編集・Excel出力 |
| 工期管理 | http://192.168.0.35:8081/kouki/ | ガントチャート・工程進捗 |
