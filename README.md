...
1. 現場管理 → 現場を開く → 下の「**現場写真**」の「**+ 写真を登録**」（上の「写真を登録」からも開けます）
2. 「写真」で撮影するか、写真を選ぶ（**まとめて 20 枚まで**）
3. **種類**（現地調査・施工前・施工中・施工後・その他）と **撮影場所**（例: 2F 東側 分電盤）を入れて「登録する」
...
- 圏外でも登録できます（上の「圏外で入力したとき」）。写真の登録画面を、電波のあるときに一度開いておいてください
