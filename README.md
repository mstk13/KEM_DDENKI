...
紙の「**作業日報集計フォーマット**」と同じ形の表を、作業員ごとに 1 か月分作れます。サイドバーの「**月次サマリ**」から開きます。

- 各作業員の行の「**集計表**」で表を開き、「**PDF**」で A4 横の PDF を出せます。上の「**作業日報集計 PDF（全員分）**」は 1 人 1 枚でまとめて出します
- 行は**承認済の日報**から 1 日 1 行で作ります。1 日に現場が複数あれば 1 行にまとめます（始業は一番早い開始、終業は一番遅い終了）
- 所定・早出・残業・深夜は Excel と同じ計算です（所定 8～17 時、休憩 10:00・12:00・15:00、深夜 22 時～。日をまたぐ勤務にも対応）
- 直せる人には行ごとに「**直す**」が出ます。始業・終業・作業内容・使用材料・**車両**・現場名を直せます。直した日は「手直し」と出て、日報をあとから直しても書き換わりません（「日報の内容に戻す」で戻せます）
- 日報の無い日を足したり、その日を集計から外したりもできます
- **直せる人**は、社長・管理者と、社長・管理者が「**集計表を直せる人**」で付けた人です。付けた人は全員分を直せます。見る・PDF を出すのは誰でもできます
- 所定・深夜・休憩の時刻は、社長・管理者が「**時間の区切り**」で変えられます
