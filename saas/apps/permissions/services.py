...
# IT 担当を表す印。判定が2か所に分かれて食い違っていたので、ここに集める（ADR-0104）。
...
def can_manage_others_work_records(user) -> bool:
    """**他人の**日報・勤怠を直したり消したりできるか（ADR-0104）。
...
# 日報の「修正」は他人の分も誰でもできる（ADR-0104 改訂、2026-09-19）。
#
