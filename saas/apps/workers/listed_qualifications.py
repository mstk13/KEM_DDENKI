...
原本: 「資格保有一覧.pdf」（株式会社ケンモチ電機 資格保有状況一覧、2026/9/15）
- 「○」の資格を、その作業員の保有資格（WorkerQualification）として資格名と区分だけ登録する。
  取得日・有効期限・原本の写真は、あとから作業員の画面で入れる
- 区分は原本の見出しに合わせる（免許・免状 / 技能講習修了証 / 特別教育修了証 / その他）
- 「△」（電気工事施工管理技士 1級 の欄の「補△」）は技士補として登録する
- 見出しの「施工監理技士」は「施工管理技士」の書き誤りとして直す
  （「監理技術者」は正しいのでそのまま）

作業員は氏名で探す。空白の有無と、髙→高・榮→栄・釼→剣 のような字の違いは同じとみなす。
同じ作業員に同じ資格名が既にあれば登録しない（何度流しても増えない）。

データ移送（workers/0018）と管理コマンド register_listed_qualifications の両方から使う。
データ移送からは履歴モデルを渡すので、モデルは引数で受け取り、
テナントで絞らない _base_manager を使う。
"""

SOURCE = "資格保有状況一覧（2026/9/15）"
...
CATEGORIES = {
    # 免許・免状
    "電気工事施工管理技士 1級": LICENSE,
    "電気工事施工管理技士 1級（技士補）": LICENSE,
    "電気工事施工管理技士 2級": LICENSE,
    "土木施工管理技士 1級": LICENSE,
    "登録電気工事基幹技能者": LICENSE,
    "電気工事士 1種": LICENSE,
    "電気工事士 2種": LICENSE,
...
# 氏名 → 保有資格（原本の行の並び。資格は原本の列の並び）
HOLDERS = {
    "釼持 陽子": [
        "電気工事施工管理技士 1級", "登録電気工事基幹技能者", "電気工事士 1種", "電気工事士 2種",
        "特種電気工事士 非常用予備発電装置工事", "運転免許証", "監理技術者",
        "一般建築物石綿含有建材調査者",
        "石綿作業主任者", "高所作業車・作業床高10m以上", "高圧ケーブル工事",
        "車両系建設機械（整地）3t以上", "地中線用GR付高圧負荷開閉器施工技術者",
        "職長・安全衛生責任者教育", "引込線", "引込線請負工事卓上講習",
        "石綿取扱作業従事者", "フルハーネス",
        "3M工法取得認定（高圧端末 常温収縮）",
    ],
    "釼持 政宏": [
        "電気工事施工管理技士 1級（技士補）", "登録電気工事基幹技能者", "電気工事士 1種",
        "電気工事士 2種", "特種電気工事士 非常用予備発電装置工事", "第二種あと施工アンカー",
        "クレーン・デリック運転士", "運転免許証", "一般建築物石綿含有建材調査者",
        "石綿作業主任者", "高所作業車・作業床高10m以上", "高圧ケーブル工事",
        "車両系建設機械（整地）3t以上", "玉掛け・吊上げ荷重1t以上",
        "地中線用GR付高圧負荷開閉器施工技術者", "職長・安全衛生責任者教育", "引込線",
        "引込線請負工事卓上講習",
        "アーク溶接", "石綿取扱作業従事者", "フルハーネス",
        "ケーブル延焼防止材による防火措置", "3M工法取得認定（高圧端末 常温収縮）",
    ],
    "高橋 章": [
        "電気工事士 1種", "電気工事士 2種", "運転免許証",
        "高所作業車・作業床高10m以上", "高圧ケーブル工事", "玉掛け・吊上げ荷重1t以上",
        "職長・安全衛生責任者教育", "引込線",
        "車両系建設機械・機重3t未満", "小型移動式クレーン", "フルハーネス",
    ],
    "江頭 敏幸": [
        "電気工事士 1種", "電気工事士 2種", "運転免許証",
        "高所作業車・作業床高10m以上", "高圧ケーブル工事", "職長・安全衛生責任者教育",
        "酸素欠乏・硫化水素危険作業主任者", "引込線",
        "車両系建設機械・機重3t未満", "小型移動式クレーン", "アーク溶接", "フルハーネス",
    ],
    "片桐 徳男": [
        "電気工事施工管理技士 1級", "電気工事士 1種", "電気工事士 2種",
        "特種電気工事士 非常用予備発電装置工事", "運転免許証", "監理技術者",
        "高所作業車・作業床高10m以上", "高圧ケーブル工事", "職長・安全衛生責任者教育",
        "引込線請負工事卓上講習",
    ],
    "茨木 浩次": [
        "電気工事士 1種", "電気工事士 2種",
        "高所作業車・作業床高10m以上", "高圧ケーブル工事", "引込線",
        "アーク溶接", "石綿取扱作業従事者", "フルハーネス", "ガス溶接",
    ],
    "出永 修": [
        "電気工事士 1種", "電気工事士 2種", "運転免許証",
        "高所作業車・作業床高10m以上", "高圧ケーブル工事", "玉掛け・吊上げ荷重1t以上",
    ...
    "佐藤 榮一": [
        "電気工事施工管理技士 2級", "電気工事士 1種", "電気工事士 2種", "運転免許証",
        "高所作業車・作業床高10m以上", "高圧ケーブル工事", "玉掛け・吊上げ荷重1t以上",
        "足場の組立て等作業主任者", "鉄骨の組立て等作業主任者", "職長・安全衛生責任者教育",
        "酸素欠乏・硫化水素危険作業主任者", "引込線",
        "小型移動式クレーン", "アーク溶接", "フルハーネス", "ガス溶接",
    ],
    "古矢 隆": [
        "電気工事施工管理技士 1級", "電気工事士 1種", "電気工事士 2種", "監理技術者",
        "高所作業車・作業床高10m以上", "高圧ケーブル工事", "移動式クレーン",
        "玉掛け・吊上げ荷重1t以上", "職長・安全衛生責任者教育", "引込線",
        "小型移動式クレーン",
    ],
    "村井 君好": [
        "電気工事施工管理技士 1級", "土木施工管理技士 1級", "電気工事士 1種", "電気工事士 2種",
        "運転免許証", "監理技術者",
        "玉掛け・吊上げ荷重1t以上", "酸素欠乏・硫化水素危険作業主任者",
        "小型移動式クレーン", "アーク溶接", "ガス溶接", "建設用リフト",
    ],
    "髙橋 翔太": [
        "運転免許証",
        "職長・安全衛生責任者教育",
    ...
    "杉本 和幸": [
        "電気工事士 2種", "運転免許証",
        "石綿作業主任者", "高所作業車・作業床高10m以上", "足場の組立て等作業主任者",
        "酸素欠乏・硫化水素危険作業主任者", "引込線",
    ],
    "梅田 義彦": [
        "電気工事施工管理技士 1級", "土木施工管理技士 1級", "電気工事士 2種", "運転免許証",
        "玉掛け・吊上げ荷重1t以上",
        "アーク溶接",
    ],
    "松倉 利昭": [
        "電気工事施工管理技士 1級", "電気工事士 1種",
    ],
}
...
def register_listed_qualifications(company, Worker, WorkerQualification, *, apply=True):
    ...
    Returns:
        {
            ...
            "existing": [(作業員名, 資格名)],  … 既に同じ資格名があるので登録しない
            "missing": [一覧の氏名],            … 作業員が見つからない
            "ambiguous": [一覧の氏名],          … 同じ氏名の在籍中の作業員が複数いる
        }
    """
    report = {"created": [], "existing": [], "missing": [], "ambiguous": []}
    if company is None:
    ...
    for listed_name, names in HOLDERS.items():
        ...
        worker = found[0]
        held = set(
            WorkerQualification._base_manager.filter(worker=worker).values_list("name", flat=True)
        )
        for name in names:
            if name in held:
