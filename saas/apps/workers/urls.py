...
urlpatterns = [
    ...
    # 作業員ごとの資格証のまとめ登録（ADR-0094）
    path(
        "<int:pk>/certificates/upload/",
        views.worker_certificate_upload, name="worker_certificate_upload",
    ),
    # 資格証の一括取り込み（ADR-0091）
    ...
    path("<int:pk>/delete/", views.worker_delete, name="delete"),
