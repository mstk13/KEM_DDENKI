...
- 自社の作業員は 9 行（作業員名・作業時間 08:30～17:30・通常時間・残業時間・宿泊）
...
def _as_office_staff(user_a_is_office_staff):
    """この画面は事務員が全員ぶんを扱う前提で動かす（ADR-0105）。詳細は conftest。"""
...
class TestSheetContents:
    def test_原本の見出しと作業員ごとの時間が載る(self, client, user_a, data):
        ...
        for expected in ("作業日報", "現場名", "A社ビル新築", "発注先", "山陽建設株式会社",
                         ...
                         "宿泊", "作業内容", "電工太郎", "電工次郎",
                         # 次郎 08:00～18:00・通常 8h・残業 1h
                         # 太郎 08:00～19:30・通常 8h・残業 2.5h
                         "電工次郎08:00～18:008h1h", "電工太郎08:00～19:308h2.5h",
        ...
        # 作業時間は時・分とも 2 桁（○○:○○～○○:○○）
        assert "08:00～19:30" in text and "8:00～" not in text.replace("08:00～", "")
